...
There are many other optimization algorithms for finding stationary points on a PES, for example the particle swarm algorithm to name just one, all with their advantages and disadvantages ... Hier fhlt noch ein Schlusssatz.
