...
the island of Kneiphopf with the rest of the mainlands via seven bridges.
%
\begin{figure}[htb]
    \centering
    ...
    \caption{The K\"onigsberg Bridge Problem. (a) Schematic representation of
    the bridge layout of K\"onigsberg with the river Pregel (blue), land and
    island (green) and bridges (red), and (b) graph representation.}
...
shown in figure~\ref{subfig:koenigsberg-graph}.
