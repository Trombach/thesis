...
interaction with surface adhesion. In the rigid sphere model the interaction
potential is 0 for distances larger than the equilibrium distance $r_s$ and goes
to infinity when the particles ``touch''. This concept can be extended by
introducing a region of attraction of width $R$ in which the potential is
defined to be $-\varepsilon$. The potential can be defined as
%
\begin{align}
    \phi(r) =
    \begin{cases}
