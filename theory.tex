...
found structure with a different particle labeling. This particle labeling
...
Besides the obvious rejection of adjacency matrices that represent the same
structure, other restrictions can be imposed to reduce the numbers of adjacency
matrices further. Most importantly, the resulting structures should be rigid,
meining not continously deformable. Thus, each sphere needs to be in contact
with at least three other spheres, which is true if each row or column of the
adjacency matrix contains at least three matrix elements of 1.
