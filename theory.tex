...
small-core potential can improve significantly the quality of energetic and other property
calculations.

An \ac{ECP} has to be based on an all-electron calculations that describe the
...
between the valence and the core region aznd keeps the valence electrons out of the core. 
