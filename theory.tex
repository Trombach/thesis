...
The general form of the \ac{LJ} potential was derived purely from thermodynamic
considerations.\autocite{Jones_DeterminationMolecularFields_1924} The equation
of state of a gas was found to be described well by a polynomial of the
following form by
...
\end{align}
%
To solve the integral in the virial coefficient $B$ the pairwise interaction
potential has to be introduced. It is possible to find analytical solutions to
this integral for various potentials, for example purely repulsive the
Sutherland potential. Lennard-Jones, however, introduced the potential in
...
\subsection{Potential Energy Landscape}
\label{sec:PotentialEnergyLandscape}
