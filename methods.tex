...
for the structures to be compared remains unchanged. 
...
coordinate input given by and object of type \verb|structure|. Two types of
...
Additionally, the investigated graphs are printed in terms of edges removed
...
implemented. The function that reads in the parameters has to be written such
