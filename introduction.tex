...
number of $N$ atoms. For this, it is useful to define a potential energy surface
that is a function of all $3N$ coordinates and maps them to their energy with
respect to the employed interaction potential. This is only allowed if the
motion of the nuclei is decoupled from the motion of the electrons
