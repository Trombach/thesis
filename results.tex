...
gold clusters by either endohedral enclosure of gold or other metal atoms, by
...
\begin{figure}[htb]
    ...
    corresponding rigid \acf{GNC}s.  Red lines indicate the edges that were removed to
...
\begin{figure}[htb]
    ...
    as sub-graphs of the icosahedral graph and corresponding rigid \acf{GNC}s. The
