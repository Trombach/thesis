...
These two cluster structures are the only ones possible when removing only six
...
other tip becomes part of the 12-sphere shell. The pentagonal bipyramid is a
structural motif that can't be realised under \ac{SHS} conditions. This can be
explained by looking at the motif as being composed of five tetrahedra glued
together at their faces. Ideal tetrahedra can't be combined in this way as two
vertices of the tetrahedra have to lose
...
as this is one of the 12 \ac{COS} contact points (figure~\ref{fig:icopent}).
This only leaves the choice of breaking one bond of the pentagonal ring, which
has to happen once for every $C_6$ axis. The only possible solutions to this
lead to the two closed-packed clusters.
...
\begin{figure}
    \centering
    \includegraphics[width=.5\textwidth]{gregory-newton/icopent.png}
