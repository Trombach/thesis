...
symmetry of the original fullerene is preserved if $k=l$ or $l=0$. The number of
vertices increases by a factor of $(k^2+kl+l^2)$. Some important transformations
are for example $GC_{1,1}$[$I_\mathrm{h}-$C$_{20}$]=$I_\mathrm{h}-$C$_{60}$
(leapfrog transformation)\autocite{Fowler-atlas-2006} and
$GC_{2,0}$[$I_\mathrm{h}-$C$_{20}$]=$I_\mathrm{h}-$C$_{80}$ (halma
transformation), both preserving the initial point group.
