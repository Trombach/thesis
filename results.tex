...
finally into the closed packed fcc or hcp structures at $N>10^5$ atoms, in
...
fcc over the hcp phase due to phonon dispersion \autocite{Schwerdtfeger-2016}.
...
To study the convergence behavior of the number of distinct (nonisomorphic) LJ minima in
...
\resizebox{\linewidth}{!}{%
    ...
    cluster size $N$ (from Refs. \autocite{Holmes-Cerfon_EnumeratingRigidSphere_2016,Hoy_Structurefinitesphere_2012,Hoy_Structuredynamicsmodel_2015}) 
...
13 & 31  & 87     				& 23   & \multirow{8}{*}{1476} & \multirow{8}{*}{1510} & \multirow{8}{*}{34} \\
   ...
   & 40  & 4      				& 3    &                       &                       &                     \\\bottomrule
    ...
    Refs.~\autocite{Holmes-Cerfon_EnumeratingRigidSphere_2016,Hoy_Structurefinitesphere_2012,Hoy_Structuredynamicsmodel_2015}.}
        \item[b]{Estimated.}
        \end{tablenotes}
    \end{threeparttable}}
\end{table}%
...
the ideal Mackay icosahedron \autocite{Hoare_Physicalclustermechanics_1975,Hoare_Statisticalmechanicsmorphology_1976,hoare79}. Simple
...
\begin{figure}
    \centering
    \subfloat[$N=11$]{\includegraphics[width=.4\textwidth]{kslj/lj11var.pdf}}
    \subfloat[$N=12$]{\includegraphics[width=.4\textwidth]{kslj/lj12var.pdf}}\\
    \subfloat[$N=13$]{\includegraphics[width=.4\textwidth]{kslj/lj13var.pdf}}
...
from SHS to LJ type clusters one has to continuously vary the exponents $(n,m)$
...
Ref.~\autocite{Holmes-Cerfon_EnumeratingRigidSphere_2016} contains a putatively complete set
...
\begin{figure}
    ...
    from Ref.~\autocite{Holmes-Cerfon_EnumeratingRigidSphere_2016}. The width of the bars is $0.01$.}
